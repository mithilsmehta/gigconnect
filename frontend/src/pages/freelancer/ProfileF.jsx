...
import { FiUser, FiMail, FiSettings, FiSun, FiMoon, FiEdit3, FiSave, FiLogOut } from "react-icons/fi";
...
export default function ProfileF() {
    ...
    const saveBasic = async () => {
        try {
            setLoading(true);
            await axios.patch("http://localhost:5000/api/auth/update-basic", {
                ...basic,
                skills: basic.skills.split(",").map(s => s.trim()).filter(s => s)
            }, {
                    ...
                    <>
                        ...
                        <div className={`card shadow-sm mb-4 ${theme === "dark" ? "bg-dark text-light border-secondary" : ""}`}>
                            <div className="card-body text-center py-4">
                                <div className="mb-3">
                                    <div className={`rounded-circle d-inline-flex align-items-center justify-content-center ${theme === "dark" ? "bg-secondary" : "bg-primary"}`}
                                ...
                                <span className={`badge ${theme === "dark" ? "bg-success" : "bg-success"} fs-6`}>
                                ...
                                <div className="col-md-10">
                                    <div className={`card shadow-sm ${theme === "dark" ? "bg-dark text-light border-secondary" : ""}`}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                <label className="form-label fw-semibold">Hourly Rate (USD)</label>
                                                <div className="input-group">
                                                    <span className={`input-group-text ${theme === "dark" ? "bg-dark text-light border-secondary" : ""}`}>$</span>
                                                    <input
                                                        type="number"
                                                        className={`form-control ${theme === "dark" ? "bg-dark text-light border-secondary" : ""}`}
                                                        placeholder="20"
                                                        value={basic.hourlyRate}
                                                        onChange={(e) => setBasic({ ...basic, hourlyRate: parseFloat(e.target.value) || 0 })}
                                                        min="0"
                                                        step="0.01"
                                                    />
                                                    <span className={`input-group-text ${theme === "dark" ? "bg-dark text-light border-secondary" : ""}`}>/hour</span>
                                                </div>
                                                <div className="form-text">Set your competitive hourly rate</div>
                                            </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => navigate("/freelancer/change-email")}
                                                >
